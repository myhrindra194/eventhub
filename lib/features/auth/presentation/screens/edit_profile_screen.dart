...
///
/// One editable field, and the screen says so. Email and role are shown —
/// greyed, with a padlock and one sentence of why — rather than hidden: a
/// user looking for "change my email" should learn it is not possible here
/// instead of wondering whether they missed a menu.
///
...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  void initState() {
    super.initState();
    _name = TextEditingController(text: ref.read(currentUserProvider)?.name);
  }
  ...
  bool get _isDirty =>
      _name.text.trim() != (ref.read(currentUserProvider)?.name ?? '');
