...
class _EventDto extends EventDto {
  const _EventDto({required this.id, required this.title, required this.description, @JsonKey(unknownEnumValue: EventCategory.other) required this.category, @TimestampConverter() required this.startsAt, required this.location, required this.capacity, required this.availablePlaces, required this.organizerId, required this.organizerName, this.imageUrl, @NullableTimestampConverter() this.createdAt, @NullableTimestampConverter() this.updatedAt, this.currency, @JsonKey(fromJson: _tiersFromJson)  List<EventTierDto> tiers = const <EventTierDto>[], @JsonKey(fromJson: _staffIdsFromJson)  List<String> staffIds = const <String>[]}): _tiers = tiers,_staffIds = staffIds,super._();
...
@override@JsonKey(fromJson: _staffIdsFromJson) List<String> get staffIds {
...
String toString() {
  final _this = this as EventTierDto;
  return 'EventTierDto(id: ${_this.id}, name: ${_this.name}, capacity: ${_this.capacity}, available: ${_this.available}, description: ${_this.description}, price: ${_this.price}, order: ${_this.order})';
}
...
class _EventTierDto extends EventTierDto {
  const _EventTierDto({required this.id, required this.name, required this.capacity, required this.available, this.description = '', this.price = 0, this.order = 0}): super._();
...
@override
String toString() {
    return 'EventTierDto(id: $id, name: $name, capacity: $capacity, available: $available, description: $description, price: $price, order: $order)';
}
