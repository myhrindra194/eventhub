...
int get hashCode {
  final _this = this as ReservationDto;
  return Object.hash(runtimeType,_this.eventId,_this.userId,_this.organizerId,_this.userName,_this.userEmail,_this.eventTitle,_this.eventStartsAt,_this.eventLocation,_this.status,_this.reservedAt,_this.cancelledAt,_this.cancelledBy,_this.tierId,_this.tierName,_this.pricePaid);
}

@override
String toString() {
  final _this = this as ReservationDto;
  return 'ReservationDto(eventId: ${_this.eventId}, userId: ${_this.userId}, organizerId: ${_this.organizerId}, userName: ${_this.userName}, userEmail: ${_this.userEmail}, eventTitle: ${_this.eventTitle}, eventStartsAt: ${_this.eventStartsAt}, eventLocation: ${_this.eventLocation}, status: ${_this.status}, reservedAt: ${_this.reservedAt}, cancelledAt: ${_this.cancelledAt}, cancelledBy: ${_this.cancelledBy}, tierId: ${_this.tierId}, tierName: ${_this.tierName}, pricePaid: ${_this.pricePaid})';
}
...
@useResult
$Res call({
 String eventId, String userId, String organizerId, String userName, String userEmail, String eventTitle,@TimestampConverter() DateTime eventStartsAt, String eventLocation,@JsonKey(unknownEnumValue: ReservationStatus.cancelled) ReservationStatus status,@TimestampConverter() DateTime reservedAt,@NullableTimestampConverter() DateTime? cancelledAt, String? cancelledBy, String? tierId, String? tierName, int pricePaid
});
...
/// Create a copy of ReservationDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eventId = null,Object? userId = null,Object? organizerId = null,Object? userName = null,Object? userEmail = null,Object? eventTitle = null,Object? eventStartsAt = null,Object? eventLocation = null,Object? status = null,Object? reservedAt = null,Object? cancelledAt = freezed,Object? cancelledBy = freezed,Object? tierId = freezed,Object? tierName = freezed,Object? pricePaid = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  String userId,  String organizerId,  String userName,  String userEmail,  String eventTitle, @TimestampConverter()  DateTime eventStartsAt,  String eventLocation, @JsonKey(unknownEnumValue: ReservationStatus.cancelled)  ReservationStatus status, @TimestampConverter()  DateTime reservedAt, @NullableTimestampConverter()  DateTime? cancelledAt,  String? cancelledBy,  String? tierId,  String? tierName,  int pricePaid)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReservationDto() when $default != null:
return $default(_that.eventId,_that.userId,_that.organizerId,_that.userName,_that.userEmail,_that.eventTitle,_that.eventStartsAt,_that.eventLocation,_that.status,_that.reservedAt,_that.cancelledAt,_that.cancelledBy,_that.tierId,_that.tierName,_that.pricePaid);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eventId,  String userId,  String organizerId,  String userName,  String userEmail,  String eventTitle, @TimestampConverter()  DateTime eventStartsAt,  String eventLocation, @JsonKey(unknownEnumValue: ReservationStatus.cancelled)  ReservationStatus status, @TimestampConverter()  DateTime reservedAt, @NullableTimestampConverter()  DateTime? cancelledAt,  String? cancelledBy,  String? tierId,  String? tierName,  int pricePaid)  $default,) {final _that = this;
switch (_that) {
case _ReservationDto():
return $default(_that.eventId,_that.userId,_that.organizerId,_that.userName,_that.userEmail,_that.eventTitle,_that.eventStartsAt,_that.eventLocation,_that.status,_that.reservedAt,_that.cancelledAt,_that.cancelledBy,_that.tierId,_that.tierName,_that.pricePaid);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eventId,  String userId,  String organizerId,  String userName,  String userEmail,  String eventTitle, @TimestampConverter()  DateTime eventStartsAt,  String eventLocation, @JsonKey(unknownEnumValue: ReservationStatus.cancelled)  ReservationStatus status, @TimestampConverter()  DateTime reservedAt, @NullableTimestampConverter()  DateTime? cancelledAt,  String? cancelledBy,  String? tierId,  String? tierName,  int pricePaid)?  $default,) {final _that = this;
switch (_that) {
case _ReservationDto() when $default != null:
return $default(_that.eventId,_that.userId,_that.organizerId,_that.userName,_that.userEmail,_that.eventTitle,_that.eventStartsAt,_that.eventLocation,_that.status,_that.reservedAt,_that.cancelledAt,_that.cancelledBy,_that.tierId,_that.tierName,_that.pricePaid);case _:
  return null;
